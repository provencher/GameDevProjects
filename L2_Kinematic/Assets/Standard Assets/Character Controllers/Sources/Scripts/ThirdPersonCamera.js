...
function Awake ()
{
	...
	{
	    var characterController2 : Collider = _target.GetComponent.<Collider>();
	    centerOffset = characterController2.bounds.center - _target.position;
	    headOffset = centerOffset;
	    headOffset.y = characterController2.bounds.max.y - _target.position.y;
...
//	DebugDrawStuff();
	...
	{
		if (/*controller.GetLockCameraTimer () < lockCameraTimeout*/true)
		{
		...
		if (AngleDistance (currentAngle, targetAngle) > 160 && /*controller.IsMovingBackwards ()*/false)
			targetAngle += 180;
